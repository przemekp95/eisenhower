...
The unchanged 19-file allowlist is refrozen at snapshot `e851ef8725cf22ee858f706b1f7b1becbec051ba30f85a6dc531c5b24a407f37`, and the versioned unapproved v2 candidate is bound to the current content versions. A clean exact-SHA local MongoDB/Qdrant comparison produced immutable report SHA-256 `383df23055202c49ba033201b6029ed6e2dff18ee009061d098c5b33cbe89b0c`: hybrid improved non-holdout Recall@5 from `0.7083` to `0.8333` and MRR@5 from `0.5833` to `0.7153`; freshness and no-answer accuracy were `1.0`, with zero duplicate, forbidden, stale and isolation hits. Hybrid still misses the proposed global and Polish quality thresholds, so dense remains the runtime default and no parameter or strategy is promoted. The technical comparison is complete; final human-attested evaluation remains blocked only on the 18 independent decisions in `human-review-v2.json`, which were not fabricated.
---
