...
def main() -> int:
  parser = argparse.ArgumentParser(
    description="Run the exact-SHA TASK-050 single-use qualification candidate."
  )
  ...
  run_calibration(
    ...
    seed_commitment_field="qualification_seed_sha256",
    schema_version="task050-qualification-v1",
    evidence_scope="synthetic_local_physical_single_use_qualification",
  )
  return 0
