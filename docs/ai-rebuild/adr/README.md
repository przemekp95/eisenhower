...
| ADR | Decision | Status |
| --- | --- | --- |
| [0001](0001-fastapi-owns-online-rag.md) | FastAPI owns the synchronous RAG path | Accepted; local implementation partial |
...
| [0006](0006-light-command-query-split.md) | Separate commands and queries lightly, without full CQRS | Accepted; durable enqueue wired, consumer absent |
| [0007](0007-ai-framework-boundary.md) | Keep the online RAG framework-neutral; use the small Python pipeline and MCP SDK v2 | Accepted; Haystack remains a research-only no-go |
